...
public class RegistrationConfirmationEmail extends BaseTest {
	@Test(dataProvider = "gdata")
	public void Registration_EnsureComfirmEmailMatchEmail(String Test_cases,String first,String last,String Email,String Confirm_Email, String Password, String DateDay,String DateMonth,String DateYear, String Gender) {
		...
		assertEquals(BaseTest.Actual, "Your emails do not match. Please try again.");
