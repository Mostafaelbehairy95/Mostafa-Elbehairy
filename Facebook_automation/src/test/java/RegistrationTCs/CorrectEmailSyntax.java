...
public class CorrectEmailSyntax extends BaseTest {
	@Test(dataProvider = "gdata")
	public void Registration_ValidEmailSyntax(String Test_cases,String first,String last,String Email,String Confirm_Email, String Password, 
			String DateDay,String DateMonth,String DateYear, String Gender) {
		...
		assertEquals(BaseTest.Actual, "Please enter a valid mobile number or email address.");
