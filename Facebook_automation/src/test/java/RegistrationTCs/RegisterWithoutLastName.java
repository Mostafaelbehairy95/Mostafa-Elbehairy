...
public class RegisterWithoutLastName extends BaseTest {
	@Test(dataProvider = "gdata")
	public void Registration_MakeSureSurName_Mandatory(String Test_cases,String first,String last,String Email,String Confirm_Email, String Password, String DateDay,String DateMonth,String DateYear, String Gender) {
		...
		if(Gender.equalsIgnoreCase("Female") ||Gender.equalsIgnoreCase("female")) {
			BaseTest.driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[1]/div[2]/div/div[2]/div/div/div[1]/form/div[1]/div[7]/span/span[1]/input")).click();
			
		}else if(Gender.equalsIgnoreCase("Male") ||Gender.equalsIgnoreCase("male")){
			BaseTest.driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[1]/div[2]/div/div[2]/div/div/div[1]/form/div[1]/div[7]/span/span[2]/input")).click();
		}
		...
		assertEquals(BaseTest.Actual, "What's your name?");
