...
public class Registration extends BaseTest {
	...
	public void Registration_MakeSureFirstName_Mandatory(String Test_cases,String first,String last,String Email,String Confirm_Email, String Password, String DateDay,String DateMonth,String DateYear, String Gender) {
		...
		Actual = BaseTest.driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[3]/div/div/div")).getText();
		
		assertEquals(Actual, "What's your name?");
