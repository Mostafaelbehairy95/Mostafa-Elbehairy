...
public class LoginVaildEmailBlankPass extends BaseTest  {
	
	@Test(dataProvider = "gdata")
	public void Login_VaildEmail_blankPass(String Test_cases,String first,String last,String Email,String Confirm_Email, String Password, 
